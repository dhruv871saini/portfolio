...
const Skill = () => {
  const skills = [
    ...
    {
      imgSrc: `${process.env.PUBLIC_URL}/images/github-repository-commit-bitbucket-github-f1cb09a95bd71f6c55c00faecadc6912.png`,
      name: "Git",
    },
    {
      imgSrc: `${process.env.PUBLIC_URL}/images/java-class-file-java-platform-standard-edition-java-development-kit-java-runtime-environment-coffee-jar-9eb251fee1a8aa98ce710f6071978a15.png`,
      name: "Java",
    },
    {
