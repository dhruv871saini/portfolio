          ...
          <div className="col-md-7">
            <div className="row">
              ...
              <div className="col-md-3">
                <div>
                  <img
                    className="images-laptop"
                    src={`${process.env.PUBLIC_URL}/images/Screenshot_2024-08-18_170446-removebg-preview.png`}
                    alt="Laptop"
                  />
                </div>
              </div>
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 1.25C6.06294 1.25 1.25 6.06294 1.25 12C1.25 17.9371 6.06294 22.75 12 22.75C17.9371 22.75 22.75 17.9371 22.75 12C22.75 6.06294 17.9371 1.25 12 1.25ZM12.7509 7C12.7509 6.58579 12.4151 6.25 12.0009 6.25C11.5867 6.25 11.2509 6.58579 11.2509 7V12.1893L10.0312 10.9697C9.73832 10.6768 9.26345 10.6768 8.97056 10.9697C8.67767 11.2626 8.67768 11.7375 8.97058 12.0303L11.4706 14.5302C11.7635 14.8231 12.2383 14.8231 12.5312 14.5302L15.0312 12.0303C15.3241 11.7375 15.3241 11.2626 15.0312 10.9697C14.7384 10.6768 14.2635 10.6768 13.9706 10.9697L12.7509 12.1893V7ZM8 16.25C7.58579 16.25 7.25 16.5858 7.25 17C7.25 17.4142 7.58579 17.75 8 17.75H16C16.4142 17.75 16.75 17.4142 16.75 17C16.75 16.5858 16.4142 16.25 16 16.25H8Z"
        fill="#000000"
      ></path>
    </svg>
  );
